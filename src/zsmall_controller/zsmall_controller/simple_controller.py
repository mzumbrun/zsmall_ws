...
class SimpleController(Node):
    ...
    def __init__(self):
        ...
        self.vel_sub_ = self.create_subscription(Twist, "zsmall_controller/cmd_vel_unstamped", self.velCallback, 10)
        self.joint_sub_ = self.create_subscription(JointState,"joint_states", self.jointCallback, 10)        
        self.odom_pub_ = self.create_publisher(Odometry, "zsmall_controller/odom", 10)
