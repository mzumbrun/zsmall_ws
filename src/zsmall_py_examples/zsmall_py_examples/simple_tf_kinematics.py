...
from zsmall_msgs.srv import GetTransform
...
class SimpleTfKinematics(Node):
    ...
    def __init__(self):
        ...
        self.static_transform_stamped_.header.frame_id = "zsmall_base"
        self.static_transform_stamped_.child_frame_id = "zsmall_top"
    ...
    def timerCallback(self):
        ...
        self.dynamic_transform_stamped_.child_frame_id = "zsmall_base"
